...
echo '<a href="' . $ref . '/constructor/' . $constructorDetails['brand_id'] . '" class="t-item clic" style="width: 100%; height: 50%">Constructeur : ' . $constructorDetails['brand_name'] . '</a>';
...
echo '<a href="' . $ref . '/edit/constructor/' . $constructorId . '"><i class="fal fa-edit"></i></a>';
echo '<a href="' . $ref . '/delete/constructor/' . $constructorId . '"><i class="fal fa-trash-alt"></i></a>';
echo '</div>';
echo '</div>';
echo '<div class="table-image-full">';
echo '<img style="width: 220px" src="' . $ref . '/img/constructors/' . $constructorDetails['brand_pic'] . '">';
echo '</div>';
...
foreach ($carsConstructor as $car) {
    ...
    echo '<p class="t-item" style="min-height: 260px"><img src="' . $ref . '/include/resize.php?s=500&f=/img/cars/' . $pic_scr . '"></p>';
    echo '</div>';
    echo '<div class="table-content">';
    echo '<a href="' . $ref . '/car/' . $car['car_id'] . '" class="t-item clic" style="width: 100%">Nom : ' . $car['car_name'] . '</a>';
