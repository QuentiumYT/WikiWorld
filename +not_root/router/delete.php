...
if ($removeType === 'car') {
    ...
    if (!$removeCar) {
        ...
        echo '<form action="' . $ref . '/include/delete_db.php" method="POST" enctype="multipart/form-data">';
        ...
        echo '</form>';
        echo '</div>';
        backButton($ref . '/' . $removeType . '/' . $removeId, 'Revenir à la voiture <br>"' . $removeCar['car_name'] . '"');
    }
    ...
    if (!$removeConstructor) {
        ...
        echo '</form>';
        echo '</div>';
        backButton($ref . '/' . $removeType . '/' . $removeId, 'Revenir au contructeur <br>"' . $removeConstructor['brand_name'] . '"');
    }
