...
echo '<a href="' . $ref . '/player/' . $playerDetails['user_id'] . '" class="t-item clic" style="width: 100%">Joueur :<br>' . $playerDetails['user_name'] . '</a>';
...
foreach ($playerFavorites as $fav) {
    echo '<tr>';
    echo '<td>' . $fav['stars'] . '<img class="star" src="' . $ref . '/img/star.png"></td>';
    ...
    echo '<td><img src="' . $ref . '/img/cars/' . $pic_scr . '"></td>';
...
backButton($ref . '/players', 'Revenir aux joueurs');
echo '</aside>';
