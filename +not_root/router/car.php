...
echo '<a href="' . $ref . '/car/' . $carDetails['car_id'] . '" class="t-item clic" style="width: 50%">Voiture : ' . $carDetails['car_name'] . '</a>';
echo '<a href="' . $ref . '/constructor/' . $carDetails['car_brand_id'] . '" class="t-item clic" style="width: 30%">Constructeur : ' . $carConstructor['brand_name'] . '</a>';
echo '<p class="t-item" style="width: 16%">Id : ' . $carDetails['car_id'] . '</p>';
echo '<div class="t-item clic col" style="width: 4%">';
echo '<a href="' . $ref . '/edit/car/' . $carId . '"><i class="fal fa-edit"></i></a>';
echo '<a href="' . $ref . '/delete/car/' . $carId . '"><i class="fal fa-trash-alt"></i></a>';
echo '</div>';
...
echo '<p class="t-item" style="width: 60%"><img src="' . $ref . '/include/resize.php?s=620&f=/img/cars/' . $pic_scr . '"></p>';
...
if (isset($_COOKIE['player_id'])) {
    ...
    echo '<p class="t-item" style="width: 10%">Étoiles :&nbsp;<span id="starsCount">5</span><img class="star" src="' . $ref . '/img/star.png"></p>';
...
foreach ($carEditions as $edition) {
    ...
    echo '<p class="t-item"><img src="' . $ref . '/include/resize.php?s=500&f=/img/cars/' . $pic_scr . '"></p>';
    echo '</div>';
    echo '<div class="table-content">';
    ...
    if (empty($edition['style_price'])) {
        ...
        $edition['style_price'] .= '<img class="money" src="' . $ref . '/img/IconCurrency_IGC.png">';
    }
    // Check if sb price is not defined
    if (empty($edition['style_price_sb'])) {
        $edition['style_price_sb'] = '/';
    } else {
        $edition['style_price_sb'] .= '<img class="money" src="' . $ref . '/img/IconCurrency_SpeedBoost.png">';
    }
